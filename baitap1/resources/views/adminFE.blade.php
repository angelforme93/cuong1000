		...
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-3 col-sm-12 col-xs-12">
					<h1>
						<a href="index"><img src="img/home/logo.png"></a>						
				...
				<div id="search" class="col-md-7 col-sm-12 col-xs-12">
					...
					<input type="text" name="text"  id="tu_tim_kiem" placeholder="Nhập từ khóa" />
					<input type="submit" name="submit" value="Tìm Kiếm" id="tutimkiem" />
					</form>
				</div>
				<div id="cart" class="col-md-2 col-sm-12 col-xs-12">
					<a class="display" href="giohang">Giỏ hàng</a>
					<a href="giohang" id="soluong_giohang">{{Cart::count()}}</a>				    
				</div>
			</div>			
		</div>
	</header><!-- /header -->
				...
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						...
						@foreach($danhmuc as $danhmuc)
							...
							<li class="menu-item"><a href="sp_danhmuc/{{$danhmuc->id}}" title="">{{$danhmuc->cate_name}}</a></li>
